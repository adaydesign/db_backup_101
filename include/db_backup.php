...
class Backup_Database {
     ...
     */
    public function record($bak_result){
        // connect database
        ...
        $sql = "INSERT INTO tb_backup_record (bak_file_name,gz,action,result)
                VALUES('".$this->backupFile."',".$this->gzipBackupFile.",0,$bak_result)";
        $rs_rec = $conn->query($sql);

        $echo_text = $rs_rec ? "Success" : "Fail!";
        $this->obfPrint("Record result: $echo_text"  , 1);
