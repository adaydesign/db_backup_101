 ...
 * @version 1.0
 * @url https://github.com/daniloaz/myphp-backup
 */
...
class Restore_Database {
     ...
     */
    function __construct($host, $username, $passwd, $dbName,$bak_file, $charset = 'utf8') {
        $this->host       = $host;
        ...
        $this->backupFile = $bak_file;// BACKUP_FILE ? BACKUP_FILE : null;
    }
...
$backup_file = $_POST["bak_file"];

$restoreDatabase = new Restore_Database(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, $backup_file);
$result = $restoreDatabase->restoreDb(BACKUP_DIR, $backup_file) ? 'OK' : 'Fail';
